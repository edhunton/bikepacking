...
STRAVA_CLIENT_ID = os.getenv("STRAVA_CLIENT_ID", "61482")
STRAVA_CLIENT_SECRET = os.getenv("STRAVA_CLIENT_SECRET", "ebd1926421defc5c8338f399cceb37a725b0253a")
STRAVA_REFRESH_TOKEN = os.getenv("STRAVA_REFRESH_TOKEN", "5be9abd202e69a440db567f5e5e551d73b4f4183")
...
@router.get("/token")
def exchange_code_for_token(code: str = Query(..., description="Authorization code from Strava OAuth redirect")):
    """
